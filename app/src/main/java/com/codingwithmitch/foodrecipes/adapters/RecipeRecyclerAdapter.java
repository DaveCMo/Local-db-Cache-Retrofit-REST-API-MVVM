...
public class RecipeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //display loading search request
    ...
    public void hideLoading() {
        if (isLoading()) {
            if (mRecipes.get(0).getTitle().equalsIgnoreCase("LOADING...")) {
                mRecipes.remove(0);
            } else if (mRecipes.get(mRecipes.size() - 1).getTitle().equalsIgnoreCase("LOADING...")) {
